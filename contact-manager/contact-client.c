...
enum SearchType
{
  SEARCH_NAME, SEARCH_TEL, SEARCH_INDEX, SEARCH_RETURN, SEARCH_ERROR
};
enum MainType
{
  MAIN_SEARCH, MAIN_EXIT, MAIN_ERROR
};
...
int main (int argc, char *argv[])
{
  ...
  if (pid == 0)
  {
    ...
    char *args[] = {
        "/home/sebastiangeiger/ClionProjects/FileOp/cmake-build-debug/contact-manager-generator",
        NULL };
